...
>;
 ...
 template <> struct tc::type_id<eobi::v13_0::messages> { using type = tc::proto_type_id<&eobi::v13_0::MessageHeaderComp::templateID>;}; 

template<> struct tc::type_id<eobi::v13_0::AddComplexInstrument> { constexpr std::uint16_t operator()() const noexcept { return 13400;} };
template<> struct tc::type_id<eobi::v13_0::AddFlexibleInstrument> { constexpr std::uint16_t operator()() const noexcept { return 13401;} };
template<> struct tc::type_id<eobi::v13_0::InstrumentSummary> { constexpr std::uint16_t operator()() const noexcept { return 13601;} };
template<> struct tc::type_id<eobi::v13_0::AddScaledSimpleInstrument> { constexpr std::uint16_t operator()() const noexcept { return 13402;} };
template<> struct tc::type_id<eobi::v13_0::PartialOrderExecution> { constexpr std::uint16_t operator()() const noexcept { return 13105;} };
template<> struct tc::type_id<eobi::v13_0::AuctionBBO> { constexpr std::uint16_t operator()() const noexcept { return 13500;} };
template<> struct tc::type_id<eobi::v13_0::FullOrderExecution> { constexpr std::uint16_t operator()() const noexcept { return 13104;} };
template<> struct tc::type_id<eobi::v13_0::TradeReversal> { constexpr std::uint16_t operator()() const noexcept { return 13200;} };
template<> struct tc::type_id<eobi::v13_0::AuctionClearingPrice> { constexpr std::uint16_t operator()() const noexcept { return 13501;} };
template<> struct tc::type_id<eobi::v13_0::CrossRequest> { constexpr std::uint16_t operator()() const noexcept { return 13502;} };
template<> struct tc::type_id<eobi::v13_0::ExecutionSummary> { constexpr std::uint16_t operator()() const noexcept { return 13202;} };
template<> struct tc::type_id<eobi::v13_0::Heartbeat> { constexpr std::uint16_t operator()() const noexcept { return 13001;} };
template<> struct tc::type_id<eobi::v13_0::InstrumentStateChange> { constexpr std::uint16_t operator()() const noexcept { return 13301;} };
template<> struct tc::type_id<eobi::v13_0::MassInstrumentStateChange> { constexpr std::uint16_t operator()() const noexcept { return 13302;} };
template<> struct tc::type_id<eobi::v13_0::OrderAdd> { constexpr std::uint16_t operator()() const noexcept { return 13100;} };
template<> struct tc::type_id<eobi::v13_0::OrderDelete> { constexpr std::uint16_t operator()() const noexcept { return 13102;} };
template<> struct tc::type_id<eobi::v13_0::OrderMassDelete> { constexpr std::uint16_t operator()() const noexcept { return 13103;} };
template<> struct tc::type_id<eobi::v13_0::TopOfBook> { constexpr std::uint16_t operator()() const noexcept { return 13504;} };
template<> struct tc::type_id<eobi::v13_0::OrderModify> { constexpr std::uint16_t operator()() const noexcept { return 13101;} };
template<> struct tc::type_id<eobi::v13_0::OrderModifySamePrio> { constexpr std::uint16_t operator()() const noexcept { return 13106;} };
template<> struct tc::type_id<eobi::v13_0::PacketHeader> { constexpr std::uint16_t operator()() const noexcept { return 13004;} };
template<> struct tc::type_id<eobi::v13_0::SnapshotOrder> { constexpr std::uint16_t operator()() const noexcept { return 13602;} };
template<> struct tc::type_id<eobi::v13_0::ProductStateChange> { constexpr std::uint16_t operator()() const noexcept { return 13300;} };
template<> struct tc::type_id<eobi::v13_0::ProductSummary> { constexpr std::uint16_t operator()() const noexcept { return 13600;} };
template<> struct tc::type_id<eobi::v13_0::QuoteRequest> { constexpr std::uint16_t operator()() const noexcept { return 13503;} };
template<> struct tc::type_id<eobi::v13_0::TESTradeReport> { constexpr std::uint16_t operator()() const noexcept { return 13203;} };
template<> struct tc::type_id<eobi::v13_0::TradeReport> { constexpr std::uint16_t operator()() const noexcept { return 13201;} };
